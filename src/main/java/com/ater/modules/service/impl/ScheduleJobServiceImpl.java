...
import com.ater.common.utils.ScheduleUtils;
import com.ater.modules.dao.ScheduleJobDao;
...
//			if (scheduleJob.getStatus() == 1) continue;
...
//		}
	...
	@Override
	@Transactional
	public void stopJobByMID(String params) {
		schedulerJobDao.stopJobByMID(params);
	}
}
